...
const Contact = () => {
    ...
    const contact_hanlder = (e) => {
        e.preventDefault()
        console.log(firstname, lastname, email, phone_number, subject, message)
    }
                ...
                <main className="overflow-hidden">
                        ...
                        <div className="py-24 lg:py-32">
                            <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
                                ...
                                <p className="mt-6 text-xl text-warm-gray-500 max-w-3xl">
                                    If you have anything you want to say to us or any feedback you want to give, or any queries, or any products that you didnt find on our platform you can contact us below
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <section className="relative" aria-labelledby="contact-heading">
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="relative bg-white shadow-xl rounded">
                                    ...
                                    <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                        ...
                                        <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                            ...
                                            <div className="sm:col-span-2 sm:flex sm:justify-end">
                                                <BlueButton text="Submit" onClick={contact_hanlder} />
                                            </div>
                                        </form>
                                    </div>
                                </div>
