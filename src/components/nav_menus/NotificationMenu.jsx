    ...
    if (error) {
        return (
            <>
                ...
                <div
                    aria-live="assertive"
                    className="z-40 fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start mt-12"
                >
                            ...
                            <div className={`max-w-sm bg-white w-full shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5`}>
                                <div className="flex flex-row items-center w-full justify-between px-4 py-2">
                                    ...
                                    <div className="ml-4 flex">
                                        <button
                                            className={` rounded-full inline-flex outline-none p-1`}
                                            onClick={() => {
                                                setShow(false)
                                            }}
                                        >
                                ...
                                <div className="p-2">
                                    <p className={`px-2 text-gray-700 text-center font-semibold p-1 text-sm rounded`}>Error, please reload page!</p>
                                </div>
                            </div>
                        </Transition>
                    </div>
    ...
    if (loading) {
        return (
            <>
                ...
                <div
                    aria-live="assertive"
                    className="fixed inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start mt-12"
                >
                    <div className="w-full flex flex-col items-center space-y-4 sm:items-end">
                        {/* Notification panel, dynamically insert this into the live region when it needs to be displayed */}
                        <Transition
                        ...
                        >
                            <div className="max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5">
                                ...
                                <div className="p-2">
                                    <p className="px-2 text-gray-700 text-center font-semibold p-1 rounded">Loading...</p>
                                </div>
