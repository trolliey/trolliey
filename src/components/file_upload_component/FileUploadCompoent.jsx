...
function FileUploadCompoent(multiple) {
    let fileObj = []
    let fileArray = []
    const upload_files = []
    ...
    const uploadFiles = (e) => {
        e.preventDefault()
        console.log(preview_files, files_to_upload)
    }

    return (
        <div className=''>
            <div className="grid grid-cols-6 items-center gap-8 my-2">
            ...
            <div className="form-group">
                <div className="px-2">
                    <div className="max-w-md mx-auto rounded-lg overflow-hidden md:max-w-xl bg-gray-200">
                        <div className="md:flex">
                            <div className="w-full p-3">
                                <div className="relative h-12 rounded-lg border-dashed border-2 border-blue-700 bg-gray-100 flex justify-center items-center">
                                    <div className="absolute">
                                        <div className="flex flex-col items-center">
                                            <span className="block text-gray-400 font-normal">Click here to add files</span> </div>
                                    </div>
                                    {
                                        multiple ? (
